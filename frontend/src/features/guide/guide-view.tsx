        ...
        <Link to="/guide/survival-guide">
          <Card className="gradient-brand flex-row items-center justify-between gap-4 border-none p-6 text-white shadow-lg shadow-primary/20 transition-transform hover:-translate-y-0.5">
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="font-display font-semibold">The Hostel Survival Guide for First-Time Students</p>
                <p className="text-sm text-white/80">Move-in day, roommates, money, safety — the full read.</p>
              </div>
            </div>
